...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("Yo", "DeathBrawl", "com.example.myapp", "0.0.1");
		...
		telemetryConfig.app_name = "DeathBrawl";
		#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "DeathBrawl", null, { width: 800, height: 600 });
